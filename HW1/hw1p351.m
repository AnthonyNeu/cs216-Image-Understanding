...
testLabel = zeros(length(labels),1);
for i = 1 :total
    display(i);
    testImage = test.data(i,:);
    testLabel(i) = kNNClassifierCosine(15,data,labels,testImage);
end
...
display(1 - correct/total);
%% plot confusion matrix
figure;
imagesc(confusionMatrix);
colorbar;
title('k=1,confusion matrix,cosine similiarity');
